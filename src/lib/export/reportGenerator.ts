...
<body>
  ...
  <div class="footer">
    Generated by Verdio Adaptive Intelligence on ${date}. This report is derived from ${result.source.rowCount.toLocaleString()} rows across ${result.profile.columnCount} columns. Semantic confidence and capability gating ensure only mathematically valid analyses are included. Model selection and financial impact are estimates to support decision making, not financial advice.
  </div>
